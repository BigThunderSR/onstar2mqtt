        ...
        describe('sensor', () => {
            ...
            it('should generate config payloads', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    json_attributes_template: "{{ {'last_updated': value_json.ambient_air_temperature_last_updated, 'status': value_json.ambient_air_temperature_status, 'status_color': value_json.ambient_air_temperature_status_color} | tojson }}",
                ...
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[1]), {
                    ...
                    device_class: 'temperature',
                    icon: 'mdi:thermometer',
                    json_attributes_template: "{{ {'last_updated': value_json.ambient_air_temperature_f_last_updated, 'status': value_json.ambient_air_temperature_f_status, 'status_color': value_json.ambient_air_temperature_f_status_color} | tojson }}",
        ...
        describe('binary_sensor', () => { // TODO maybe not needed, payloads not diff
            ...
            it('should generate config payloads', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[1]), {
                    ...
                    json_attributes_template: "{{ {'last_updated': value_json.priority_charge_indicator_last_updated, 'status': value_json.priority_charge_indicator_status, 'status_color': value_json.priority_charge_indicator_status_color} | tojson }}",
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute for left front tire', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    json_attributes_template: "{{ {'recommendation': value_json.tire_pressure_placard_front, 'message': value_json.tire_pressure_lf_message, 'last_updated': value_json.tire_pressure_lf_last_updated, 'status': value_json.tire_pressure_lf_status, 'status_color': value_json.tire_pressure_lf_status_color} | tojson }}",
                    name: 'Tire Pressure: Left Front',
                    payload_available: 'true',
                    payload_not_available: 'false',
                    state_topic: 'homeassistant/sensor/XXX/tire_pressure/state',
            ...
            it('should generate payloads with an attribute for right front tire', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[4]), {
                    ...
                    device_class: 'pressure',
                    icon: 'mdi:car-tire-alert',
                    json_attributes_template: "{{ {'recommendation': value_json.tire_pressure_placard_front, 'message': value_json.tire_pressure_rf_message, 'last_updated': value_json.tire_pressure_rf_last_updated, 'status': value_json.tire_pressure_rf_status, 'status_color': value_json.tire_pressure_rf_status_color} | tojson }}",
            ...
            it('should generate payloads with an attribute for left rear tire', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[1]), {
                    ...
                    device_class: 'pressure',
                    icon: 'mdi:car-tire-alert',
                    json_attributes_template: "{{ {'recommendation': value_json.tire_pressure_placard_rear, 'message': value_json.tire_pressure_lr_message, 'last_updated': value_json.tire_pressure_lr_last_updated, 'status': value_json.tire_pressure_lr_status, 'status_color': value_json.tire_pressure_lr_status_color} | tojson }}",
            ...
            it('should generate payloads with an attribute for right rear tire', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[5]), {
                    ...
                    device_class: 'pressure',
                    icon: 'mdi:car-tire-alert',
                    json_attributes_template: "{{ {'recommendation': value_json.tire_pressure_placard_rear, 'message': value_json.tire_pressure_rr_message, 'last_updated': value_json.tire_pressure_rr_last_updated, 'status': value_json.tire_pressure_rr_status, 'status_color': value_json.tire_pressure_rr_status_color} | tojson }}",
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    device_class: undefined,
                    icon: 'mdi:oil',
                    json_attributes_template: "{{ {'message': value_json.oil_life_message, 'last_updated': value_json.oil_life_last_updated, 'status': value_json.oil_life_status, 'status_color': value_json.oil_life_status_color} | tojson }}",
                    name: 'Oil Life',
                    payload_available: 'true',
                    payload_not_available: 'false',
        ...
        describe('sensor', () => {
            ...
            it('should generate config payloads', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    json_attributes_template: "{{ {'last_updated': value_json.fuel_amount_last_updated, 'status': value_json.fuel_amount_status, 'status_color': value_json.fuel_amount_status_color} | tojson }}",
                    name: 'Fuel Amount',
                    payload_available: 'true',
                    payload_not_available: 'false',
                ...
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[1]), {
                    ...
                    device_class: 'volume_storage',
                    icon: 'mdi:gas-station',
                    json_attributes_template: "{{ {'last_updated': value_json.fuel_capacity_last_updated, 'status': value_json.fuel_capacity_status, 'status_color': value_json.fuel_capacity_status_color} | tojson }}",
                    name: 'Fuel Capacity',
                    payload_available: 'true',
                    payload_not_available: 'false',
                    state_topic: 'homeassistant/sensor/XXX/fuel_tank_info/state',
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    json_attributes_template: "{{ {'last_updated': value_json.lifetime_fuel_econ_last_updated, 'status': value_json.lifetime_fuel_econ_status, 'status_color': value_json.lifetime_fuel_econ_status_color} | tojson }}",
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    json_attributes_template: "{{ {'last_updated': value_json.ev_plug_state_last_updated, 'status': value_json.ev_plug_state_status, 'status_color': value_json.ev_plug_state_status_color} | tojson }}",
                    name: 'Ev Plug State',
                    payload_available: 'true',
                    payload_not_available: 'false',
                    payload_off: false,
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    device_class: undefined,
                    icon: 'mdi:flash',
                    json_attributes_template: "{{ {'last_updated': value_json.charger_power_level_last_updated, 'status': value_json.charger_power_level_status, 'status_color': value_json.charger_power_level_status_color} | tojson }}",
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    device_class: undefined,
                    icon: 'mdi:leaf-circle',
                    json_attributes_template: "{{ {'last_updated': value_json.electric_economy_last_updated, 'status': value_json.electric_economy_status, 'status_color': value_json.electric_economy_status_color} | tojson }}",
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    device_class: 'distance',
                    icon: 'mdi:ev-station',
                    json_attributes_template: "{{ {'last_updated': value_json.ev_range_last_updated, 'status': value_json.ev_range_status, 'status_color': value_json.ev_range_status_color} | tojson }}",
                    name: 'Ev Range',
                    payload_available: 'true',
                    payload_not_available: 'false',
        ...
        describe('attributes', () => {
            ...
            it('should generate payloads with an attribute', () => {
                assert.deepStrictEqual(mqtt.getConfigPayload(d, d.diagnosticElements[0]), {
                    ...
                    json_attributes_template: "{{ {'last_updated': value_json.ev_charge_state_last_updated, 'status': value_json.ev_charge_state_status, 'status_color': value_json.ev_charge_state_status_color} | tojson }}",
    ...
    describe('additional tests for uncovered lines', () => {
        ...
        it('should handle undefined diagnostic elements in getConfigPayload', () => {
            ...
            const expectedPayload = {
                ...
                json_attributes_template: "{{ {'last_updated': value_json._last_updated, 'status': value_json._status, 'status_color': value_json._status_color} | tojson }}",
                unit_of_measurement: undefined,
                payload_available: 'true',
                payload_not_available: 'false',
            };
